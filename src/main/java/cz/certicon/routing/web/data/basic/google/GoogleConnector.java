...
public class GoogleConnector {
     ...
     * Application name.
     */
    private static final String APPLICATION_NAME = "Google Apps Script Execution API Java Quickstart";

    /**
     * Directory to store user credentials for this application.
     */
    private final java.io.File DATA_STORE_DIR = new java.io.File( System.getProperty( "user.home" ), ".credentials/script-java-quickstart.json" );
     ...
     */
    private final List<String> SCOPES = Arrays.asList( "https://www.googleapis.com/auth/drive" );
